            ...
            <nav class="flex-1 px-4 py-6">
                ...
                <div class="mb-8">
                    ...
                    <a href="{{ route('approval.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('approval.*') ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-500 hover:bg-gray-50' }} transition-all mb-1">
                        ...
                        @if($pendingCount > 0)
                            <span class="ml-auto w-2 h-2 bg-red-500 rounded-full shadow-sm"></span>
                    ...
                    <a href="{{ route('tagihan.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('tagihan.*') ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-500 hover:bg-gray-50' }} transition-all mb-1">
                        ...
                        @if($tagihanCount > 0)
                            <span class="ml-auto w-2 h-2 bg-red-500 rounded-full shadow-sm" title="{{ $tagihanCount }} Tagihan Belum Dibayar"></span>
                        @endif
                    </a>
                    ...
                    <a href="{{ route('komplain.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('komplain.*') ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-500 hover:bg-gray-50' }} transition-all">
    
                        <svg class="w-5 h-5 {{ request()->routeIs('komplain.*') ? 'text-blue-600' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mb-8">
                    ...
                    <a href="{{ route('pengeluaran.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium {{ request()->routeIs('pengeluaran.*') ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-500 hover:bg-gray-50' }} transition-all">
                        <svg class="w-5 h-5 {{ request()->routeIs('pengeluaran.*') ? 'text-blue-600' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
